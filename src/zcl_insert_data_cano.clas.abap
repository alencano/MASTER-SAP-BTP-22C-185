CLASS zcl_insert_data_cano DEFINITION
PUBLIC
 FINAL
 CREATE PUBLIC .
 PUBLIC SECTION.
...
CLASS zcl_insert_data_cano IMPLEMENTATION.
...
@lt_booking.
 ...
 INTO CORRESPONDING FIELDS OF TABLE
@lt_book_sup.
 DELETE FROM: ztb_travel_cano,
 ztb_booking_cano,
 ztb_booksuppl_cn.
 INSERT: ztb_travel_cano FROM TABLE @lt_travel,
 ztb_booking_cano FROM TABLE @lt_booking,
 ztb_booksuppl_cn FROM TABLE @lt_book_sup.
 out->write( 'DONE!' ).
